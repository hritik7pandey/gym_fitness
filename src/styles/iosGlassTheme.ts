...
export const iosGlassTheme = {
   ...
   * Enhanced blur for maximum transparency with dark theme
   */
  blur: {
    soft: '40px',      // Inputs, small chips, subtle overlays
    medium: '50px',    // Cards, secondary panels
    strong: '60px',    // Primary panels, prominent cards
    overlay: '70px',   // Full-screen overlays, modals, backdrops
  },
   ...
   */
  alpha: {
    ultraLight: 0.03,  // Maximum transparency - decorative elements only
    light: 0.05,       // Light panels, secondary cards
    normal: 0.08,      // Standard cards, default glass surfaces
    medium: 0.1,       // Prominent panels, important content containers
    strong: 0.15,      // Modals, overlays requiring focus
    solid: 0.25,       // Near-opaque, high-contrast content areas
  },
  ...
  colors: {
    ...
    // Text colors (optimized for dark grey glass backgrounds)
    text: {
      primary: '#e2e8f0',
