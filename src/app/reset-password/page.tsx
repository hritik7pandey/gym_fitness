...
function ResetPasswordContent() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6 py-12 relative overflow-hidden bg-gradient-to-br from-[#F6F9FF] via-[#EEF2FF] to-[#E6E9FF]">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center space-x-3 mb-2 group">
            ...
            <span className="gradient-title text-3xl font-bold drop-shadow-[0_2px_10px_rgba(45,110,248,0.3)]">
              Fitsense
            </span>
          </Link>
          <p className="text-[#1C1C1E]/70 mt-2">Create a new password</p>
        </div>
              ...
              <div className="flex justify-center space-x-2">
                {otp.map((digit, index) => (
                  <input
                    ...
                    className="w-10 h-12 text-center text-xl font-bold glass-chip border-2 border-white/30 focus:border-[#2D6EF8] focus:outline-none focus:ring-2 focus:ring-[#2D6EF8]/50 transition-all text-[#1C1C1E]"
        ...
        <div className="mt-6 text-center">
          <Link href="/auth/signin" className="text-[#1C1C1E]/60 hover:text-[#1C1C1E] transition-colors font-medium">
            ← Back to Login
          </Link>
        </div>
      </div>
