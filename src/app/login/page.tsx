...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#f0f4ff] via-[#fafbff] to-[#f5f3ff] relative overflow-hidden flex items-center justify-center p-4">
      ...
      <div className="absolute bottom-20 right-10 w-96 h-96 bg-gradient-to-br from-indigo-400/20 to-pink-400/20 rounded-full blur-3xl animate-float-delayed" />
      ...
      >
        <div className="glass-panel overflow-hidden">
          <div className="p-8 md:p-10">
            ...
            >
              <h1 className="gradient-title text-3xl md:text-4xl font-bold mb-2"
                style={{ filter: 'drop-shadow(0 0 20px rgba(90, 140, 255, 0.3))' }}>
                Welcome Back
              </h1>
              <p className="text-[#1C1C1E]/70 font-medium">
            ...
            >
              ...
              <div className="flex items-center justify-between text-sm">
                <label className="flex items-center text-gray-700 cursor-pointer group">
                  <input 
                    type="checkbox" 
                    className="mr-2 w-4 h-4 rounded border-gray-300 text-blue-600 focus:ring-blue-500 focus:ring-offset-0 focus:ring-2 transition-all"
                  />
