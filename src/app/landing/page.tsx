  ...
  return (
    <div className="min-h-screen" style={{ background: 'linear-gradient(135deg, #2d3748 0%, #1a202c 100%)' }}>
      ...
      <section id="features" className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-100 mb-4">Built for Results</h2>
            <p className="text-xl text-gray-300">Everything you need to achieve your fitness goals</p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((feature, index) => (
              <div key={index} className="p-6 rounded-3xl" style={{ background: 'rgba(255,255,255,0.08)', backdropFilter: 'blur(40px)', border: '1px solid rgba(255,255,255,0.15)' }}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              <div key={stat.label} className="text-center p-6 rounded-3xl" style={{ background: 'rgba(255,255,255,0.08)', backdropFilter: 'blur(40px)', border: '1px solid rgba(255,255,255,0.15)' }}>
                <div className="text-4xl md:text-5xl font-bold text-gray-100 mb-2">{stat.value}</div>
      ...
      <section id="pricing" className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-100 mb-4">Simple, Transparent Pricing</h2>
            <p className="text-xl text-gray-300">Choose the plan that fits your fitness journey</p>
          </div>
          <div className="grid md:grid-cols-3 gap-6">
            {pricingTiers.map((tier) => (
              <div key={tier.name} className="p-8 rounded-3xl relative" style={{ background: tier.popular ? 'rgba(122,167,255,0.15)' : 'rgba(255,255,255,0.08)', backdropFilter: 'blur(40px)', border: tier.popular ? '2px solid rgba(122,167,255,0.3)' : '1px solid rgba(255,255,255,0.15)' }}>
      ...
      <section id="testimonials" className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-100 mb-4">Loved by Thousands</h2>
            <p className="text-xl text-gray-300">See what our members have to say</p>
          </div>
      ...
      <section className="relative py-20">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl md:text-6xl font-bold text-gray-100 mb-6">Ready to Transform Your Life?</h2>
          <p className="text-xl md:text-2xl text-gray-300 mb-12 max-w-2xl mx-auto">Join 50,000+ Indians who are already achieving their fitness goals with Fitsense</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <MotionButton variant="primary" size="lg" onClick={() => router.push('/auth/signup')}>Start Free Trial →</MotionButton>
            <MotionButton variant="secondary" size="lg" onClick={() => alert('🎥 Watch Demo\n\nSee how Fitsense helps you:\n• Track workouts & progress\n• Get personalized meal plans\n• Connect with trainers\n• Achieve your fitness goals\n\nDemo video coming soon!')}>Watch Demo</MotionButton>
          </div>
          <p className="text-gray-500 mt-8">No credit card required • 7-day free trial • Cancel anytime</p>
        </div>
      </section>
