    ...
    <div className="min-h-screen bg-mist-gradient p-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-400">Configure the floating contact button for your members</p>
        </div>
        ...
        <div className="glass-card-strong p-8 space-y-6">
          ...
          <div className="flex items-center justify-between p-4 glass-chip">
            <div>
              <h3 className="font-bold text-white mb-1">Enable Contact Widget</h3>
              <p className="text-sm text-gray-400">Show floating contact button on all pages</p>
            </div>
