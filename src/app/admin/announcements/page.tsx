...
export default function AdminAnnouncementsPage() {
  ...
  return (
    <div className="min-h-screen p-6" style={{ background: 'linear-gradient(135deg, #2d3748 0%, #1a202c 100%)' }}>
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-400">Create and manage announcements for your members</p>
          </div>
                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="px-3 py-1 text-xs font-bold rounded-pill bg-gray-200 text-gray-300">
                      ...
                      <span className={`px-3 py-1 text-xs font-bold rounded-pill ${
                        announcement.isActive ? 'bg-green-500 text-white' : 'bg-gray-300 text-gray-300'
                      }`}>
                        {announcement.isActive ? '● ACTIVE' : '○ INACTIVE'}
                      </span>
                    </div>
                    <h3 className="text-xl font-bold text-white mb-2">{announcement.title}</h3>
                    <p className="text-gray-400 mb-4 line-clamp-2">{announcement.message}</p>
