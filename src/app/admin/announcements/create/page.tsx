        ...
        <div className="flex items-center gap-4 mb-8">
          <Link href="/admin/announcements">
            <motion.button
              ...
              whileTap={{ scale: 0.9 }}
              className="w-10 h-10 rounded-full glass-chip flex items-center justify-center text-gray-700 hover:text-gray-900"
            >
              ←
            </motion.button>
          </Link>
        ...
        <form onSubmit={handleSubmit} className="glass-card-strong p-8 space-y-6">
              ...
              <div className="mt-3 space-y-2">
                {['basic', 'premium', 'vip'].map((type) => (
                  <label key={type} className="flex items-center gap-2 p-3 glass-chip cursor-pointer hover:bg-white/40 transition-all">
                    ...
                    />
                    <span className="font-semibold text-gray-700 capitalize">{type} Members</span>
                  </label>
                ))}
              </div>
            )}
          ...
          <div className="space-y-3">
            <label className="flex items-center gap-3 p-4 glass-chip cursor-pointer hover:bg-white/40 transition-all">
              ...
              />
              <div>
                <span className="font-bold text-gray-900">📌 Sticky Announcement</span>
                <p className="text-sm text-gray-600">Keep this announcement at the top</p>
              </div>
            </label>
            ...
            <label className="flex items-center gap-3 p-4 glass-chip cursor-pointer hover:bg-white/40 transition-all">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Make announcement visible immediately</p>
              </div>
            </label>
          </div>
