    ...
    <div className="min-h-screen relative overflow-hidden" style={{ background: 'linear-gradient(135deg, #2d3748 0%, #1a202c 30%, #2d3748 60%, #1a202c 100%)' }}>
      ...
      <section aria-label="Nutrition tracking" className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 pb-24 lg:pb-8 space-y-5">
        ...
        <motion.header
          ...
          <h2 className="text-[32px] lg:text-[40px] font-[800] text-white" style={{ fontFamily: 'SF Pro Display, -apple-system, sans-serif' }}>
            🍎 Nutrition
          </h2>
          <p className="text-[15px] lg:text-[17px] font-[600] text-gray-300 mt-1.5" style={{ fontFamily: 'SF Pro, -apple-system, sans-serif' }}>Track your daily meals and macros</p>
        </motion.header>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
          <AnimatedGlassCard delay={0.1} depth="medium">
            <div className="text-center">
              ...
              <h3 className="text-xs font-medium text-gray-400 mb-1.5">Calories</h3>
          ...
          <AnimatedGlassCard delay={0.2} depth="medium">
            <div className="text-center">
              ...
              <h3 className="text-sm font-medium text-gray-400 mb-2">Protein</h3>
          ...
          <AnimatedGlassCard delay={0.3} depth="medium">
            <div className="text-center">
              <div className="text-4xl mb-3">🍞</div>
              <h3 className="text-sm font-medium text-gray-400 mb-2">Carbs</h3>
          ...
          <AnimatedGlassCard delay={0.4} depth="medium">
            <div className="text-center">
              <div className="text-4xl mb-3">🧈</div>
              <h3 className="text-sm font-medium text-gray-400 mb-2">Fats</h3>
                ...
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3">
                  ...
                  <div className="flex items-center gap-4 lg:gap-6">
                    ...
                    <button
                      ...
                      className={`px-4 py-2 rounded-xl text-sm font-medium transition-all cursor-pointer ${meal.logged
...
export default function NutritionPage() {
  return (
    <HubAccessGuard feature="nutrition tracking and meal logging">
      <NutritionContent />
    </HubAccessGuard>
  );
}
