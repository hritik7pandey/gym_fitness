      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-5 lg:space-y-6">
          ...
          <AnimatedGlassCard delay={0.5}>
            ...
            <p className="text-sm text-gray-600 mb-4">Update your details</p>
          ...
          <AnimatedGlassCard delay={0.6}>
            <h3 className="text-2xl font-bold text-gray-900 mb-2">Your Stats 📊</h3>
            <p className="text-sm text-gray-600 mb-4">Progress overview</p>
          ...
          <AnimatedGlassCard delay={0.7}>
            ...
            <p className="text-sm text-gray-600 mb-4">Unlock more badges</p>
      ...
      <div className="mt-8">
        <AnimatedGlassCard delay={0.8}>
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-6">
            <div>
              <h3 className="text-2xl font-bold text-gray-900">Account Settings ⚙️</h3>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            <Link 
              ...
              <div className="font-semibold text-slate-800 text-sm lg:text-base mb-1 group-hover:gradient-title transition-all">Password</div>
              <div className="text-xs text-slate-600">Change password</div>
            </Link>
            <Link 
              href="/settings?tab=membership"
              className="p-4 glass-chip text-left hover:scale-105 transition-all group">
              <div className="text-2xl mb-2">💳</div>
              <div className="font-semibold text-slate-800 text-sm lg:text-base mb-1 group-hover:gradient-title transition-all">Membership</div>
              <div className="text-xs text-slate-600">View & upgrade</div>
            </Link>
            <Link 
              href="/settings?tab=notifications"
              className="p-4 glass-chip text-left hover:scale-105 transition-all group">
              <div className="text-2xl mb-2">🔔</div>
              <div className="font-semibold text-slate-800 text-sm lg:text-base mb-1 group-hover:gradient-title transition-all">Notifications</div>
              <div className="text-xs text-slate-600">Email & alerts</div>
            </Link>
            <Link 
              href="/settings?tab=account"
              className="p-4 glass-chip text-left hover:scale-105 transition-all group">
              <div className="text-2xl mb-2">👤</div>
              <div className="font-semibold text-slate-800 text-sm lg:text-base mb-1 group-hover:gradient-title transition-all">Account Info</div>
              <div className="text-xs text-slate-600">Update details</div>
            </Link>
          </div>
        </AnimatedGlassCard>
      </div>
