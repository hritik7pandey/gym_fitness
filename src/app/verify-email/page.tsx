    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-12 relative overflow-hidden" style={{ background: 'linear-gradient(135deg, #2d3748 0%, #1a202c 30%, #2d3748 60%, #1a202c 100%)' }}>
      ...
      <div className="w-full max-w-md relative z-10">
            ...
            <div className="flex justify-center gap-3">
              {otp.map((digit, index) => (
                <input
                  ...
                  className="w-12 h-14 text-center text-2xl font-bold glass-chip border-2 border-white/30 focus:border-[#2D6EF8] focus:outline-none focus:ring-2 focus:ring-[#2D6EF8]/50 transition-all text-white"
        ...
        <div className="mt-6 text-center">
          <Link href="/auth/signin" className="text-gray-400 hover:text-gray-200 transition-colors text-sm font-medium">
            ← Back to Login
          </Link>
        </div>
      </div>
