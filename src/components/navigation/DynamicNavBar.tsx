          ...
          >
            {navItems.map((item, index) => (
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="px-5 py-2.5 text-gray-700 hover:text-neon-blue font-semibold transition-all duration-300 rounded-full hover:bg-white/40 hover:backdrop-blur-xl hover:shadow-ambient relative cursor-pointer"
              >
                {item.label}
              </motion.button>
            ))}
          ...
          >
            <Link href="/auth/signin">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="hidden sm:block px-5 py-2.5 text-gray-700 font-bold rounded-full transition-all duration-300 hover:text-neon-blue hover:shadow-ambient"
                style={{
