...
export const TopNav: React.FC<TopNavProps> = ({ role }) => {
  ...
  return (
    <div className="hidden md:flex lg:hidden sticky top-0 z-40 px-4 pt-4">
      <nav className="w-full rounded-[28px] px-6 py-4" style={{ background: 'rgba(255,255,255,0.18)', backdropFilter: 'blur(32px) saturate(180%)', WebkitBackdropFilter: 'blur(32px) saturate(180%)', border: '1px solid rgba(255,255,255,0.25)', boxShadow: '0 12px 32px rgba(0,0,0,0.18), inset 0 1px 0 rgba(255,255,255,0.35)' }}>
        <div className="flex items-center justify-between w-full">
          ...
          <button
            ...
            className="relative ml-2 w-10 h-10 rounded-full flex items-center justify-center text-gray-700 hover:bg-gray-100 transition-all"
          >
