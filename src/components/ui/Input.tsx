    ...
    <div className="w-full">
      ...
      <div className="relative">
        ...
        <input
          ...
          } rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-iosBlue focus:ring-opacity-50 transition-all duration-200 ${className}`}
